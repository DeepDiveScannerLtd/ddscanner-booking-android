...
public class FunDiveWithDcListItemViewModel {

    private FunDiveWithDc funDive;

    public FunDiveWithDcListItemViewModel(FunDiveWithDc funDive) {
        this.funDive = funDive;
    }

    public FunDiveWithDc getFunDive() {
        return funDive;
    }
